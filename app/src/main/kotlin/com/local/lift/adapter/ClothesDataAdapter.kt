...
import com.local.locallift.databinding.ViewHolderClothesDataBinding
import com.squareup.picasso.Picasso

class ClothesDataAdapter: ListAdapter<ProductDataItem, ClothesDataAdapter.DataViewHolder>(ClothesDataDiffCallback()) {
    class ClothesDataDiffCallback:DiffUtil.ItemCallback<ProductDataItem>() {
    ...
    class DataViewHolder(private var binding:ViewHolderClothesDataBinding):RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DataViewHolder {
        ...
        val binding = ViewHolderClothesDataBinding.inflate(inflater, parent, false)
