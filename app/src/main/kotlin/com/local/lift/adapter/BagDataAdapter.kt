...
class BagDataAdapter: ListAdapter<ProductDataItem, BagDataAdapter.DataViewHolder>(DataDiffCallback()) {
    ...
    class DataViewHolder(private var binding: ViewHolderBagDataBinding):RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DataViewHolder {
        ...
        val binding = ViewHolderBagDataBinding.inflate(inflater, parent, false)
